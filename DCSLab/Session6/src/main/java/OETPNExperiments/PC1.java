...
public class PC1 {
    ...
    public static PetriNet PN3() {
        ...
        p35.SetName("p35");
        p35.Value = new TransferOperation("170.20.10.4", "1080", "p6");
    ...
    public static PetriNet PN4() {
        ...
        p44.SetName("p44");
        p44.Value = new TransferOperation("192.168.208.93","1090","p6");
    ...
    public static void main(String[] args) {
        ...
        p3Send.Value = new TransferOperation("192.168.208.93", "1090", "p22");
        ...
        Condition T1Ct2 = new Condition(t1, "p2", TransitionCondition.MoreThanOrEqual,"constantVal");
...
// ----------------------------------------
        ...
        // add 2nd subgouard to t1
        Condition T1Ct12 = new Condition(t1, "p1", TransitionCondition.NotNull);
        Condition T1Ct22 = new Condition(t1, "p2", TransitionCondition.LessThan,"constantVal");

...
//		mpn.PlaceList.add(p34);
	...
	public static PetriNet SubPetriNet() {
		...
		grdT33.Activations.add(new Activation(t33, "p34", TransitionOperation.SendOverNetwork, "p34Send"));
		...
		Condition T34Ct1 = new Condition(t34, "p33", TransitionCondition.NotNull);
		Condition T34Ct2 = new Condition(t34, "p33", TransitionCondition.MoreThanOrEqual, "constantFour");
	...
	public static void main(String[] args) {
		...
		// P3 =  new SubPetri in labsheet from page 13
	...
	//	p2.SetValue(1.0f); //testing
		...
		grd12.Activations.add(new Activation(t1, "SubPetriNet", TransitionOperation.Copy, "p3"));

...
*/
		/*FLRS flrs2x2 = new FLRS(
				new FV(FZ.NL, FZ.ZR), new FV(FZ.NL, FZ.NM), new FV(FZ.NL, FZ.NL), new FV(FZ.NM, FZ.NL),new FV(FZ.ZR, FZ.NL),
				new FV(FZ.NL, FZ.PM), new FV(FZ.NL, FZ.ZR), new FV(FZ.NM, FZ.NM), new FV(FZ.ZR, FZ.NL),new FV(FZ.NL, FZ.NL),
				...
				new FV(FZ.PL, FZ.PL), new FV(FZ.PM, FZ.PL), new FV(FZ.PL, FZ.PL), new FV(FZ.PL, FZ.PM),new FV(FZ.PL, FZ.ZR));
*/

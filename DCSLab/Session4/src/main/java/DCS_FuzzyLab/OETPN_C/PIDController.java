...
public class PIDController {
    public static void main (String[]args) throws FileNotFoundException {
       ...
       // pn.SetInputFile("D:\\4\\DCS\\DCSLab\\DCSLab4\\PetriInputData\\PIController.txt"); //for testing PI controller alone, put initial marking in p2 and p4, T7 must all be commented
        ...
        DataFuzzy p12 = new DataFuzzy(); // Place for the derivative term
        p12.SetName("P12");
        p12.SetValue(new Fuzzy(0.0F));
        pn.PlaceList.add(p12);

        DataFuzzy p13 = new DataFuzzy(); // Place for the derivative term
        p13.SetName("P13");
        p13.SetValue(new Fuzzy(0.0F));
        pn.PlaceList.add(p13);

        DataFuzzy p14 = new DataFuzzy(); // Place for the derivative term
        p14.SetName("P14");
        p14.SetValue(new Fuzzy(0.0F));
        ...
        input3.add(new PlaceNameWithWeight("P5", 0.7F));
        input3.add(new PlaceNameWithWeight("P14", 0.3F));
        ...
        input5.add(new PlaceNameWithWeight("P8", 0.3F));
...
// T7 ------------------------------------------------
        ...
        grdT3.Activations.add(new Activation(t9, adder, input9, TransitionOperation.FLRS, Output9));

...
public class HTC {
	...
	pn.SetInputFile("D:\\4\\DCS\\DCSLab\\DCSLab4\\PetriInputData\\HTC.txt");
	...
	// T1 ------------------------------------------------
		...
		Condition T8Ct2 = new Condition(t8, "P9", TransitionCondition.NotNull);
		...
		input8.add(new PlaceNameWithWeight("P10", w1)); // to be checked
		input8.add(new PlaceNameWithWeight("P9", w2));

		ArrayList<String> Output8 = new ArrayList<>();
		Output8.add("P11");

		grdT8.Activations.add(new Activation(t8, adder, input8, TransitionOperation.FLRS, Output8));
		...
		input7.add(new PlaceNameWithWeight("P10", 1F));

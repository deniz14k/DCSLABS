...
public class WheatherInput {
	public static void main(String[] args) throws InterruptedException, IOException {
		File plant = new File("D:\\4\\DCS\\DCSLab\\DCSLab4\\PetriInputData\\OutsideTemp.txt");
		Files.deleteIfExists(plant.toPath());

		File RTC = new File("D:\\4\\DCS\\DCSLab\\DCSLab4\\PetriInputData\\RTC.txt");
		Files.deleteIfExists(RTC.toPath());

		File HTC = new File("D:\\4\\DCS\\DCSLab\\DCSLab4\\PetriInputData\\HTC.txt");

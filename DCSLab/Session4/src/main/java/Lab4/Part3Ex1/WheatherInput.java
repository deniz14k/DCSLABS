package main.java.Lab4.Part3Ex1;
...
public class WheatherInput {
	public static void main(String[] args) throws InterruptedException, IOException {
		File plant = new File("C:/Users/deniz/Downloads/DCSLABS/DCSLab/Session4/PetriInputData/OutsideTemp.txt");
		Files.deleteIfExists(plant.toPath());

		File RTC = new File("C:/Users/deniz/Downloads/DCSLABS/DCSLab/Session4/PetriInputData/RTC.txt");
		Files.deleteIfExists(RTC.toPath());

		File HTC = new File("C:/Users/deniz/Downloads/DCSLABS/DCSLab/Session4/PetriInputData/HTC.txt");
		...
		for (int i = 0; i < extermeEvening.length; i++) {
			fwPlant.write("v1:" + extermeEvening[i] + "F\n");

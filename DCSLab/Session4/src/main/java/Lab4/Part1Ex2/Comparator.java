package main.java.Lab4.Part1Ex2;
...
public class Comparator {
    public static void main (String[]args) throws FileNotFoundException {
        ...
        //changed here to match the condition
        FLRS separator = new FLRS(new FV(FZ.FF,FZ.NL), new FV(FZ.FF,FZ.NL), new FV(FZ.FF,FZ.FF), new FV(FZ.PL,FZ.FF),new FV(FZ.PL,FZ.FF));

        differentiator.Print();
        separator.Print();


        pn.SetInputFile("C:/Users/deniz/Downloads/Lab4/Lab4/Part1Ex1/comparator.txt");

...
public class RTC {
	...
	pn.SetInputFile("C:/Users/deniz/Downloads/DCSLABS/DCSLab/Session4/PetriInputData/RTC.txt");
	...
	PauseCommand.SetValue(new NetworkCommand(Enumerations.NetworkCommands.Pause));

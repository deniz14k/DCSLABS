package main.java.Lab4.Part3Ex2;
...
public class HTC {
	...
	pn.SetInputFile("C:/Users/deniz/Downloads/DCSLABS/DCSLab/Session4/PetriInputData/HTC.txt");
	...
	// The stuff for the PI controller
	DataFuzzy p9 = new DataFuzzy();
	p9.SetName("P9");
	p9.SetValue(new Fuzzy(0.0F));
	pn.PlaceList.add(p9);
	...
	// T1 ------------------------------------------------
			...
			t4.InputPlaceName.add("P11");

			Condition T4Ct1 = new Condition(t4, "P11", TransitionCondition.NotNull);
			...
			input4.add(new PlaceNameWithWeight("P11", 1.2F));
			...
			grdT7.Activations.add(new Activation(t7, OneXOneDefaultTable, input7, TransitionOperation.FLRS, Output7));
			...
			Condition T8Ct2 = new Condition(t8, "P10", TransitionCondition.NotNull);
			...
			input8.add(new PlaceNameWithWeight("P9", 0.8F));
			input8.add(new PlaceNameWithWeight("P10", 0.2F));

			ArrayList<String> Output8 = new ArrayList<>();
			Output8.add("P11");

			grdT8.Activations.add(new Activation(t8, doubleChannelAdder, input8, TransitionOperation.FLRS, Output8));

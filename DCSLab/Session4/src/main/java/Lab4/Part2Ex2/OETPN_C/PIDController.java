...
public class PIDController {
	public static void main (String[]args) throws FileNotFoundException {
		...
		pn.SetInputFile("C:/Users/deniz/Downloads/Lab4/Lab4/Part2Ex1_2/PIController.txt");
		// for testing PI controller alone, put initial marking in p2 and p4, T7 must all be commented
		...
		p2.SetName("P2");
		p2.SetValue(new Fuzzy(0.0F)); // for testing the pid controller alone
		pn.PlaceList.add(p2);
		...
		p4.SetName("P4");
		p4.SetValue(new Fuzzy(0.0F)); // for testing the pid controller alone
		pn.PlaceList.add(p4);
...
//
//		ArrayList<PlaceNameWithWeight> input3 = new ArrayList<>();
//		input3.add(new PlaceNameWithWeight("P5", 0.9F));
//		input3.add(new PlaceNameWithWeight("P14", 0.2F));
//
//
//		ArrayList<String> Output3 = new ArrayList<>();
//		Output3.add("P8");
...
//		pn.Transitions.add(t3);
		...
		input9.add(new PlaceNameWithWeight("P7", 0.8F));
